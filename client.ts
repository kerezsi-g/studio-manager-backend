// Code generated by the Encore v1.44.5 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-studio-manager-q3ni.encr.app`
}
...
/**
 * Client is an API client for the studio-manager-q3ni Encore application.
 */
...
export interface ClientOptions {
     ...
     */
    auth?: core.AuthParams | AuthDataGenerator
}
...
export namespace Core {
    ...
    export class ServiceClient {
        ...
        public async checkIdentity(): Promise<api.CheckIdentityResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/users/auth`)
            return await resp.json() as api.CheckIdentityResponse
        }
        ...
        public async signIn(params: api.SignInRequest): Promise<api.SignInResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/users/auth`, JSON.stringify(params))
            return await resp.json() as api.SignInResponse
        }
    }
}
...
export type AuthDataGenerator = () =>
  | core.AuthParams
  | Promise<core.AuthParams | undefined>
  | undefined;
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "studio-manager-q3ni-Generated-TS-Client (Encore/v1.44.5)";
        }
    ...
    async getAuthData(): Promise<CallParameters | undefined> {
        let authData: core.AuthParams | undefined;
